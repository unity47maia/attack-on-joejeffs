...
namespace Valve.VR.InteractionSystem
{
	...
	public class Longbow : MonoBehaviour
	{
		...
		private const float minPull = 0.000005f;
		private const float maxPull = 1f;
		private float nockDistanceTravelled = 0f;
		private float hapticDistanceThreshold = 0.01f;
		private float lastTickDistance;
		private const float bowPullPulseStrengthLow = 500;
		private const float bowPullPulseStrengthHigh = 1000;
		private Vector3 bowLeftVector;

		public float arrowMinVelocity = 3f;
		public float arrowMaxVelocity = 30000000f;
		private float arrowVelocity = 30000000f;
